...
const SecurityLinks: EuiPinnableListGroupItemProps[] = [
  { label: 'Overview', href: `${pathPrefix}/security-nav/` },
  { label: 'Alerts', href: `${pathPrefix}/security-nav/alerts` },
];
...
const CollapsibleNav = () => {
   ...
   * Accordion toggling
   */
  const [openGroups, setOpenGroups] = useState(['Security']);
    ...
    <EuiCollapsibleNav
      ...
      <EuiFlexItem className="eui-yScroll">
        <EuiCollapsibleNavGroup
          ...
          onToggle={(isOpen: boolean) => toggleAccordion(isOpen, 'Security')}>
          <EuiPinnableListGroup
